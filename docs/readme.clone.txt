...
Step #3: change all template name prefix to the new module dirname, including all templates in /templates/ and /templates/blocks/. For example, change planet_index.tpl to newmodule_index.tpl (required)
